...
/**
 * A szerver h�l�zati kommunik�ci�j�t �rja le.
 */
public class SerialServer extends Network implements IGameState{
	...
	/**
	 * Elk�ldi az aktu�lis j�t�k �llapot�t le�r� oszt�lyt.
	 * @param gs A j�t�k aktu�lis �llapota.
	 */
